...
Fabric is powerful, but many projects repeat the same low-level key-value boilerplate code.
Hypernate exists to reduce that repetition and keep business logic clear and focused.
...
- [API Reference - Registry](api/registry.md)
- [API Reference - Annotations](api/annotations.md)
